...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty goJianTou;
    ...
    protected virtual void OnEnable()
    {
        ...
        goJianTou = serializedObject.FindProperty("goJianTou");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(goJianTou, new GUIContent("goJianTou", "Snap the vertical input to a whole value."));
