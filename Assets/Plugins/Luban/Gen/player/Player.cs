...
public sealed partial class Player :  Bright.Config.BeanBase 
{
    public Player(JSONNode _json) 
    {
    ...
    public static Player DeserializePlayer(JSONNode _json)
    {
        return new player.Player(_json);
    }
    ...
    public const int __ID__ = 1256899246;
