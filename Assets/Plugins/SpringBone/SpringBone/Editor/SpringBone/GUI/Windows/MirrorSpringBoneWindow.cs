...
namespace UTJ
{
    public class MirrorSpringBoneWindow : EditorWindow
    {
        ...
        private Rect ShowUtilityButtons(Rect uiRect)
        {
            ...
            if (GUI.Button(uiRect, "从当前选取中..", SpringBoneGUIStyles.ButtonStyle))
            {
            ...
            if (GUI.Button(halfButtonRect, "X < 0的骨骼为源", SpringBoneGUIStyles.ButtonStyle))
            {
            ...
            if (GUI.Button(halfButtonRect, "全选copy源", SpringBoneGUIStyles.ButtonStyle))
            {
            ...
            halfButtonRect.x += halfRectWidth + Spacing;
            if (GUI.Button(halfButtonRect, "全选copy目标", SpringBoneGUIStyles.ButtonStyle))
            {
            ...
            if (GUI.Button(uiRect, "全选择", SpringBoneGUIStyles.ButtonStyle))
            {
        ...
        private Rect ShowBoneList(Rect uiRect)
        {
            ...
            GUI.Label(headerRowRect, "源", SpringBoneGUIStyles.LabelStyle);
            headerRowRect.x += headerRowRect.width;
            GUI.Label(headerRowRect, "→ 目标", SpringBoneGUIStyles.LabelStyle);
