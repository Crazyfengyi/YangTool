...
namespace YangTools
{
    ...
    /// 声音管理者
    /// </summary>
    public class YangToolAudioManager : MonoBehaviour
    {
        public static YangToolAudioManager Instance { get; private set; }
        ...
        public static void Init()
        {
            ...
            Instance = audioObject.AddComponent<YangToolAudioManager>();
            audioObject.transform.SetParent(YangTools.DontDestoryObject.transform);
